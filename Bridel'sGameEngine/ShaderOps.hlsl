...
{
	// build the transform (rotation) into same space as tan\bitan\normal (target space)
	...
	const in float specularPower)
{
	...
	// calculate specular component color baset on angle between
	// viewing vector and reflection vector, narrow eith power function
